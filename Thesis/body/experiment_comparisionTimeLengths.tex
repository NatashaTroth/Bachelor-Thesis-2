...
\begin{figure}
  ...
  \begin{subfigure}{.475\textwidth}
    ...
    \caption{Number of light green evaluation score "wins" (1h or 3h dataset) for the 1h data files.}
  ...
  \begin{subfigure}{.475\textwidth}
    ...
    \caption{Number of light green evaluation score "wins" (1h or 3h dataset) for the 3h data files.}
...
\begin{figure}
  ...
  \caption{Top evaluation scores performers comparison from figures \ref{figure:clusteringResultsGraph1h}, \ref{figure:clusteringResultsGraph3h}, and \ref{figure:clusteringResultsGraphTotal}. The light green highlighted cells indicate the best value across the different time lengths for that score.}
